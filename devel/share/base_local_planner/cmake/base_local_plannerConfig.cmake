...
if("TRUE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/relaybot/gpsbot_ws_sweep/src/navigation/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/relaybot/gpsbot_ws_sweep/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/relaybot/gpsbot_ws_sweep/install)
...
if(NOT "/home/relaybot/gpsbot_ws_sweep/devel/include;/home/relaybot/gpsbot_ws_sweep/src/navigation/base_local_planner/include " STREQUAL " ")
  set(base_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws_sweep/devel/include;/home/relaybot/gpsbot_ws_sweep/src/navigation/base_local_planner/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws_sweep/src/navigation/base_local_planner/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
