...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /home/relaybot/gpsbot_ws_sweep/src/ros_arduino_bridge/turtlebot_apps/turtlebot_calibration)
  set(turtlebot_calibration_DEVEL_PREFIX /home/relaybot/gpsbot_ws_sweep/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /home/relaybot/gpsbot_ws_sweep/install)
...
if(NOT "/home/relaybot/gpsbot_ws_sweep/devel/include " STREQUAL " ")
  set(turtlebot_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws_sweep/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws_sweep/src/ros_arduino_bridge/turtlebot_apps/turtlebot_calibration/${idir}'.  Ask the maintainer 'OSRF <turtlebot@osrfoundation.org>' to fix it.")
    endif()
