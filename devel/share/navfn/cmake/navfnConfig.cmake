...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/relaybot/gpsbot_ws_sweep/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/relaybot/gpsbot_ws_sweep/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/relaybot/gpsbot_ws_sweep/install)
...
if(NOT "/home/relaybot/gpsbot_ws_sweep/devel/include;/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/relaybot/gpsbot_ws_sweep/devel/include;/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
