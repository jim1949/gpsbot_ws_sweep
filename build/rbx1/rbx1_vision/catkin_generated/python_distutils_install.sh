...
echo_and_run cd "/home/relaybot/gpsbot_ws_sweep/src/rbx1/rbx1_vision"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/relaybot/gpsbot_ws_sweep/src/rbx1/rbx1_vision/setup.py" \
    build --build-base "/home/relaybot/gpsbot_ws_sweep/build/rbx1/rbx1_vision" \
    install \
    $DESTDIR_ARG \
