...
echo_and_run cd "/home/relaybot/gpsbot_ws_sweep/src/rbx1/rbx1_nav"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/relaybot/gpsbot_ws_sweep/src/rbx1/rbx1_nav/setup.py" \
    build --build-base "/home/relaybot/gpsbot_ws_sweep/build/rbx1/rbx1_nav" \
    install \
    $DESTDIR_ARG \
