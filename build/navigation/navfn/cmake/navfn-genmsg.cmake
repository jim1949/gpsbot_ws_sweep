...
get_filename_component(_filename "/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/srv/SetCostmap.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/srv/SetCostmap.srv" ""
)

get_filename_component(_filename "/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/srv/MakeNavPlan.srv" NAME_WE)
add_custom_target(_navfn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "navfn" "/home/relaybot/gpsbot_ws_sweep/src/navigation/navfn/srv/MakeNavPlan.srv" "geometry_msgs/Point:geometry_msgs/PoseStamped:geometry_msgs/Quaternion:std_msgs/Header:geometry_msgs/Pose"
)
